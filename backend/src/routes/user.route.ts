...
import { initProfile, getCurrentUser, updateUserDetails, deleteUser, changeUserCurrentPassword, requestPasswordRecovery, resetPassword, logoutUser } from '../controllers/user.controller.js'
