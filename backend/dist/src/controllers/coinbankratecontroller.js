...
const getExchangeRates = asyncHandler(async (req, res) => {
    try {
        const response = await fetch("https://v6.exchangerate-api.com/v6/6c726f2eef74105ff040df4b/latest/USD");
        if (!response.ok) {
            throw new ApiError({
        ...
        return res
            .status(200)
            .json(new ApiResponse(200, "Exchange rates fetched successfully", data));
    }
    catch {
        throw new ApiError({
            statusCode: 500,
...
const getCryptoMarkets = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        return res
            .status(200)
            .json(new ApiResponse(200, "Cryptocurrency data fetched successfully", filteredData));
    }
    catch {
        throw new ApiError({
            statusCode: 500,
...
export { getExchangeRates, getAllCountries, getCryptoMarkets, getBanksByCountry, };
//# sourceMappingURL=coinbankratecontroller.js.map